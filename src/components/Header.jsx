  ...
  return (
    <div className={`${theme === "dark" ? "dark" : ""}`}>
      <div
        ...
        } items-center justify-between w-full px-0 py-3`}
      >
        <div
          className="flex items-center justify-evenly gap-1 rounded-[15px] hover:bg-white hover:shadow-lg dark:hover:bg-gray-700 hover:px-3 cursor-pointer transition-all duration-200"
        ...
        <div
          className={`flex flex-col md:flex-row items-center w-4/5 md:w-3/5 lg:w-1/2 xl:w-2/5 justify-between md:justify-end gap-2`}
        >
            ...
            <div className="h-full w-full flex flex-col items-center justify-center text-center gap-4">
              ...
              <div className="w-full flex items-center justify-center gap-2 flex-wrap">
                ...
                <div
                  className="transition-all duration-200 flex items-center justify-center text-center gap-2 rounded-full p-1 bg-white text-black border-2 border-white cursor-pointer hover:p-2 hover:bg-gray-700 hover:text-white"
                  onClick={() =>
                    linkRedirect("https://www.linkedin.com/in/harshpx/")
                  }
                >
                ...
                <div
                  className="transition-all duration-200 flex items-center justify-center text-center gap-2 rounded-full p-1 bg-white text-black border-2 border-white cursor-pointer hover:p-2 hover:bg-gray-700 hover:text-white"
                  onClick={() =>
                    linkRedirect("https://www.instagram.com/harshhh.hhhh/")
                  }
                >
                  <FaInstagram size={18} />
                  <div>Instagram</div>
              ...
              <p className="mt-4">
                This weather application is built using React.js, Tailwind CSS
                and Ant Design.
                <br />
                And is powered by OpenWeather + Geoapify APIs.
              </p>
              <div className="flex items-center justify-center gap-1">
                <FaGithub size={18} />
                <span>Source Code: </span>
                <a
                  href="https://github.com/harshpx/weather"
                  target="_blank"
                  className={`${
                    theme === "dark" ? "text-indigo-400" : "text-indigo-500"
                  } hover:underline`}
                >
                  github.com/harshpx/weather
                </a>
              </div>
            </div>
          </Modal>
